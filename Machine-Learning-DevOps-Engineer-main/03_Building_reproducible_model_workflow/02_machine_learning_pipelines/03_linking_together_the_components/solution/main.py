...
def go(config: DictConfig):
    ...
    if config:
        ...
        print("No configuration found, running with default parameters")

    if not os.path.isdir(os.path.join(root_path, "download_data")):
        raise ValueError("Could not find the download_data component")
